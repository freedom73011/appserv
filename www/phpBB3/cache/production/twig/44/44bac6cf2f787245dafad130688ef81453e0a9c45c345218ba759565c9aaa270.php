...
/* viewforum_body.html */
class __TwigTemplate_fb0ffcaeab07bfde4be523593bf1db2b0ebd84aa37d0a4af642d8ed4831359d7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t";
            ...
            if (((twig_get_attribute($this->env, $this->source, $context["topicrow"], "S_TOPIC_REPORTED", [], "any", false, false, false, 157) || twig_get_attribute($this->env, $this->source, $context["topicrow"], "S_TOPIC_UNAPPROVED", [], "any", false, false, false, 157)) || twig_get_attribute($this->env, $this->source, $context["topicrow"], "S_POSTS_UNAPPROVED", [], "any", false, false, false, 157))) {
                echo " reported";
            }
            echo "\">
\t\t\t";
