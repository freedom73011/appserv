...
/* navbar_footer.html */
class __TwigTemplate_6c04e2ccdd7138e0e6351e0dbb6939a95ab54ebe4c18c4d01da0d906f074f643 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t</span>
\t\t\t\t";
            $___internal_133ca0b94813e46fc4782473176a21109e07c9a6a50151246082294f822c9f00_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
            // line 7
            echo twig_spaceless($___internal_133ca0b94813e46fc4782473176a21109e07c9a6a50151246082294f822c9f00_);
            // line 14
            echo "\t\t\t";
        }
        // line 15
...
\t\t\t</span>
\t\t\t";
        $___internal_acebf84143e313ee186f3622993cd2a14a38eea139a1c848cd3a78d3a9564991_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        // line 16
        echo twig_spaceless($___internal_acebf84143e313ee186f3622993cd2a14a38eea139a1c848cd3a78d3a9564991_);
        // line 23
        echo "\t\t\t";
        // line 24
        echo "\t\t</li>
