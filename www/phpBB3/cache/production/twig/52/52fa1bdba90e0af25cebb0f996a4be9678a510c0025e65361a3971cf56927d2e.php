...
class __TwigTemplate_26c208cd495c643760f5355fd333cb9708cd27abb65681709dbdebd94f4476b4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t";
            // line 83
            if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "leader", [], "any", false, false, false, 83))) {
                // line 84
...
\t";
                ...
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "leader", [], "any", false, false, false, 95));
                foreach ($context['_seq'] as $context["_key"] => $context["leader"]) {
                    // line 96
                    echo "\t\t<tr class=\"";
                    if ((twig_get_attribute($this->env, $this->source, $context["leader"], "S_ROW_COUNT", [], "any", false, false, false, 96) % 2 == 0)) {
                        echo "bg1";
                    } else {
                        echo "bg2";
                    }
...
\t\t\t<td class=\"name\">";
                    // line 97
                    echo twig_get_attribute($this->env, $this->source, $context["leader"], "USERNAME_FULL", [], "any", false, false, false, 97);
                    echo "</td>
\t\t\t<td>";
                    // line 98
                    if (twig_get_attribute($this->env, $this->source, $context["leader"], "S_GROUP_DEFAULT", [], "any", false, false, false, 98)) {
...
\t\t\t<td class=\"posts\">";
                    // line 99
                    echo twig_get_attribute($this->env, $this->source, $context["leader"], "USER_POSTS", [], "any", false, false, false, 99);
                    echo "</td>
\t\t\t<td class=\"joined\">";
                    // line 100
                    echo twig_get_attribute($this->env, $this->source, $context["leader"], "JOINED", [], "any", false, false, false, 100);
                    echo "</td>
\t\t\t<td class=\"mark\">&nbsp;</td>
\t\t</tr>
\t";
...
\t";
            // line 108
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "member", [], "any", false, false, false, 108));
            $context['_iterated'] = false;
            foreach ($context['_seq'] as $context["_key"] => $context["member"]) {
                // line 109
                echo "\t\t";
                if (twig_get_attribute($this->env, $this->source, $context["member"], "S_PENDING", [], "any", false, false, false, 109)) {
                    // line 110
                    echo "\t\t\t<table class=\"table1\">
\t\t\t<thead>
\t\t\t<tr>
...
$context["member"], "S_APPROVED", [], "any", false, false, false, 121)) {
                    // line 122
                    echo "\t\t\t";
...
\t\t";
                    ...
                    // line 138
                    echo "\t\t\t<tr class=\"";
                    if ((twig_get_attribute($this->env, $this->source, $context["member"], "S_ROW_COUNT", [], "any", false, false, false, 138) % 2 == 0)) {
                        echo "bg1";
                    } else {
                        echo "bg2";
                    }
...
\t\t\t\t<td class=\"name\">";
                    // line 139
                    echo twig_get_attribute($this->env, $this->source, $context["member"], "USERNAME_FULL", [], "any", false, false, false, 139);
                    echo "</td>
\t\t\t\t<td>";
                    // line 140
                    if (twig_get_attribute($this->env, $this->source, $context["member"], "S_GROUP_DEFAULT", [], "any", false, false, false, 140)) {
                        echo $this->extensions['phpbb\template\twig\extension']->lang("YES");
                    } else {
                        echo $this->extensions['phpbb\template\twig\extension']->lang("NO");
                    }
...
\t\t\t\t<td class=\"posts\">";
                    // line 141
                    echo twig_get_attribute($this->env, $this->source, $context["member"], "USER_POSTS", [], "any", false, false, false, 141);
                    echo "</td>
\t\t\t\t<td class=\"joined\">";
                    // line 142
                    echo twig_get_attribute($this->env, $this->source, $context["member"], "JOINED", [], "any", false, false, false, 142);
                    echo "</td>
\t\t\t\t<td class=\"mark\"><input type=\"checkbox\" name=\"mark[]\" value=\"";
                    // line 143
                    echo twig_get_attribute($this->env, $this->source, $context["member"], "USER_ID", [], "any", false, false, false, 143);
                    echo "\" /></td>
\t\t\t</tr>
\t\t";
                }
...
\t";
            // line 161
            if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "pagination", [], "any", false, false, false, 161))) {
                // line 162
...
\t\t\t";
                ...
                $this->loadTemplate("pagination.html", "ucp_groups_manage.html", 164)->display($context);
                if ($namespace) {
                    $this->env->setNamespaceLookUpOrder($previous_look_up_order);
                }
                // line 165
...
\t";
            // line 210
            if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "leader", [], "any", false, false, false, 210))) {
                // line 211
...
\t\t";
                // line 221
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "leader", [], "any", false, false, false, 221));
                foreach ($context['_seq'] as $context["_key"] => $context["leader"]) {
                    // line 222
                    echo "\t\t<li class=\"row";
                    if ((twig_get_attribute($this->env, $this->source, ($context["attachrow"] ?? null), "S_ROW_COUNT", [], "any", false, false, false, 222) % 2 == 1)) {
                        echo " bg1";
                    } else {
                        echo " bg2";
                    }
...
\t\t\t\t\t\t<a href=\"";
                    // line 226
                    echo twig_get_attribute($this->env, $this->source, $context["leader"], "U_EDIT", [], "any", false, false, false, 226);
                    echo "\" class=\"topictitle\"";
                    if (twig_get_attribute($this->env, $this->source, $context["leader"], "GROUP_COLOUR", [], "any", false, false, false, 226)) {
                        echo " style=\"color: #";
                        echo twig_get_attribute($this->env, $this->source, $context["leader"], "GROUP_COLOUR", [], "any", false, false, false, 226);
                        echo ";\"";
                    }
                    echo ">";
                    echo twig_get_attribute($this->env, $this->source, $context["leader"], "GROUP_NAME", [], "any", false, false, false, 226);
                    echo "</a>
\t\t\t\t\t\t";
                    // line 227
                    if (twig_get_attribute($this->env, $this->source, $context["leader"], "GROUP_DESC", [], "any", false, false, false, 227)) {
                        echo "<br />";
                        echo twig_get_attribute($this->env, $this->source, $context["leader"], "GROUP_DESC", [], "any", false, false, false, 227);
                    }
                    // line 228
                    echo "\t\t\t\t\t</div>
\t\t\t\t</dt>
\t\t\t\t<dd class=\"option\"><span><a href=\"";
                    // line 230
                    echo twig_get_attribute($this->env, $this->source, $context["leader"], "U_EDIT", [], "any", false, false, false, 230);
                    echo "\" >";
                    echo $this->extensions['phpbb\template\twig\extension']->lang("EDIT");
                    echo "</a></span></dd>
\t\t\t\t<dd class=\"option\"><span><a href=\"";
                    // line 231
                    echo twig_get_attribute($this->env, $this->source, $context["leader"], "U_LIST", [], "any", false, false, false, 231);
                    echo "\">";
...
";
        ...
        $this->loadTemplate("ucp_footer.html", "ucp_groups_manage.html", 246)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
    ...
    {
        return array (  741 => 246,  737 => 244,  730 => 239,  724 => 237,  720 => 235,  708 => 231,  702 => 230,  698 => 228,  693 => 227,  681 => 226,  669 => 222,  665 => 221,  656 => 215,  652 => 214,  647 => 211,  645 => 210,  642 => 209,  635 => 205,  631 => 204,  618 => 196,  610 => 194,  603 => 190,  599 => 189,  591 => 187,  584 => 183,  579 => 181,  568 => 175,  564 => 174,  558 => 173,  551 => 168,  546 => 165,  534 => 164,  530 => 162,  528 => 161,  523 => 158,  514 => 155,  506 => 150,  501 => 147,  496 => 146,  490 => 143,  486 => 142,  482 => 141,  474 => 140,  470 => 139,  461 => 138,  453 => 133,  449 => 132,  445 => 131,  441 => 130,  437 => 129,  432 => 126,  427 => 123,  424 => 122,  422 => 121,  415 => 117,  411 => 116,  407 => 115,  403 => 114,  399 => 113,  394 => 110,  391 => 109,  386 => 108,  383 => 107,  378 => 104,  368 => 100,  364 => 99,  356 => 98,  352 => 97,  343 => 96,  339 => 95,  332 => 91,  328 => 90,  324 => 89,  320 => 88,  316 => 87,  311 => 84,  309 => 83,  306 => 82,  304 => 81,  298 => 78,  294 => 77,  290 => 76,  286 => 74,  274 => 73,  264 => 66,  259 => 65,  251 => 60,  247 => 59,  243 => 58,  235 => 56,  228 => 52,  219 => 45,  213 => 43,  202 => 39,  194 => 38,  186 => 37,  178 => 36,  170 => 34,  167 => 33,  165 => 32,  144 => 30,  140 => 29,  135 => 28,  126 => 25,  111 => 24,  106 => 23,  98 => 19,  96 => 18,  91 => 16,  88 => 15,  82 => 12,  79 => 11,  77 => 10,  67 => 5,  52 => 3,  49 => 2,  37 => 1,);
    }
