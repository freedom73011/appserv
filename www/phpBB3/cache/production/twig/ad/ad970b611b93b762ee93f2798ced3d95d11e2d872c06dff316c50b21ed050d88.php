...
/* faq_body.html */
class __TwigTemplate_640021caa8ca57c7d055c62efad5e7170aae8f279dc17df26e4fde889ad4ac41 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["faq_block"]) {
            ...
            if ((twig_get_attribute($this->env, $this->source, $context["faq_block"], "S_ROW_COUNT", [], "any", false, false, false, 28) % 2 == 1)) {
                echo "bg1";
            } else {
                echo "bg2";
            }
