...
$lang = array_merge($lang, array(
	...
	// 參考 https://area51.phpbb.com/docs/dev/3.3.x/language/plurals.html 以獲得更多的資訊
	// 或者，詢問翻譯團隊以獲得協助。
	'PLURAL_RULE'		=> 0,
	...
	'AUTH_PROVIDER_OAUTH_ERROR_ALREADY_LINKED'				=> '此外部服務已經與另一個帳號相關聯。',
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_ENTRY'               => '無效的資料庫條目。',
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_SERVICE_TYPE'        => '提供 OAuth 的服務處理程序是無效的服務類型。',
	'AUTH_PROVIDER_OAUTH_ERROR_REQUEST'						=> '執行 OAuth 請求時出了點問題。',
	'AUTH_PROVIDER_OAUTH_RETURN_ERROR'						=> '外部的服務傳回了錯誤的值，因此無法處理您的請求。',
	...
	'AVATAR_NO_UPLOAD_DIR'			=> '頭像儲存的路徑不存在或不可寫。',
	'AVATAR_NO_UPLOAD_PATH'			=> '啟用了頭像上傳，但未設定頭像儲存的路徑。',
	...
	'DISPLAY_POSTS' => '顯示文章 ',
	'DISPLAY_TOPICS'    => '顯示主題 ',
	'DOMAIN_NO_MX_RECORD_EMAIL'	=> '輸入的電子郵件網域沒有有效的 MX 記錄。',
	'DOWNLOADED'    => '已下載',
	...
	'FILESYSTEM_CANNOT_CHANGE_FILE_GROUP'		=> '無法改變檔案群組',
	'FILESYSTEM_CANNOT_CHANGE_FILE_PERMISSIONS'	=> '無法改變檔案權限',
	'FILESYSTEM_CANNOT_COPY_FILES'				=> '無法複製檔案',
	'FILESYSTEM_CANNOT_CREATE_SYMLINK'			=> '無法創造符號連結',
	'FILESYSTEM_CANNOT_CREATE_DIRECTORY'		=> '無法創造目錄',
	'FILESYSTEM_CANNOT_DELETE_FILES'			=> '無法從系統中刪除檔案',
	'FILESYSTEM_CANNOT_DUMP_FILE'				=> '無法轉儲到檔案',
	'FILESYSTEM_CANNOT_MIRROR_DIRECTORY'		=> '無法鏡像目錄',
	'FILESYSTEM_CANNOT_RENAME_FILE'				=> '無法從系統中重新命名檔案',
	'FILESYSTEM_CANNOT_TOUCH_FILES'				=> '無法創造檔案或更改檔案時間戳',
	...
	'LOGIN_ERROR_ATTEMPTS'            => '您的登入錯誤，超過了討論區設定的嘗試次數上限。現在除了輸入您的會員名稱和密碼外，必須通過 CAPTCHA 測試。',
	...
	'NOTIFICATION_REPORT_PM_CLOSED'		=> ' <strong>私訊檢舉已結案</strong> 由 %1$s：',
	...
	// 與 NOTIFICATION_BOOKMARK 和 NOTIFICATION_POST 結合使用。
	...
	'NO_STYLE_DATA'             => '無法得到關於 user_style %s 風格的資料以及關於 user_id %s 的設定',
	'NO_STYLE_CFG'				=> '無法得到風格的設定檔案：%s',
	'NO_SUBJECT'    => '沒有輸入標題',
	...
	'POST_UNAPPROVED_EXPLAIN'	=> '除非獲得版主核准，否則其他會員看不到這篇文章。',
	...
	'TOTAL_POSTS_COUNT'	=> array(
		1   => '總共有 <strong>%d</strong> 篇文章',
	),
	'TOPIC_REPORTED'    => '這個主題已被檢舉',
	'TOTAL_TOPICS'		=> array(
		1   => '總共有 <strong>%d</strong> 個主題',
	),
	'TOTAL_USERS'		=> array(
		1   => '總共有 <strong>%d</strong> 位會員',
	),
