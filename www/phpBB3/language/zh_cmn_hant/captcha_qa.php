...
$lang = array_merge($lang, array(
	...
	'EDIT_QUESTION'				=> '編輯問題',
	'QUESTIONS'					=> '問題',
	'QUESTIONS_EXPLAIN'         => '對於每個表單提交，您已經啟用了問答集外掛，使用者將被問及在此所指定的問題。要使用這個外掛，至少要有一個問題被設定在預設的語言中。這些問題也許對您的使用者來說很容易回答，但是它超出機器人能夠運用 Google™ 搜尋的能力。只需要一個適當的問題。如果您開始接收垃圾郵件註冊，則應更改問題。如果您的問題回覆，需要混和大小寫、標點符號或空格，那麼啟用嚴格的設定。',
