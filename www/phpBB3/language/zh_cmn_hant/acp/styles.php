...
$lang = array_merge($lang, [
	'ACP_STYLES_EXPLAIN'						=> '在這裡，您可以管理在您討論區可用的風格。<br>請注意，您無法卸載「<strong>prosilver</strong>」風格，因為它是 phpBB 的預設與主要的父風格。',
	...
	'UNINSTALL_PROSILVER'						=> '您不能卸載「prosilver」風格。',
	'UNINSTALL_DEFAULT'							=> '您不能卸載預設風格。',

	'BROWSE_STYLES_DATABASE'					=> '瀏覽風格資料庫',
]);
