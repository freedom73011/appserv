...
$lang = array_merge($lang, array(
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'	=> '除了版主、以及管理員可以看見之外，對所有會員隱藏此個人資料欄位。如果個人資料欄位不顯示在會員控制台，那麼會員將無法看見或改變此欄位，此欄位的值只能由管理員改變。',
	...
	'STEP_3_EXPLAIN_CREATE'			=> '因為討論區安裝了多種語言，您也必須填寫其餘的語言項目。如果不這樣做，則將使用此自訂個人資料欄位的預設語言設定，您也可以稍後填寫其餘的語言項目。',
	'STEP_3_EXPLAIN_EDIT'			=> '因為討論區安裝了多種語言，您現在也可以更改或增加其餘的語言項目。如果不這樣做，則將使用此自訂個人資料欄位的預設語言設定。',
