...
$lang = array_merge($lang, array(
	...
	'FORUM_DESC'						=> '描述',
	'FORUM_DESC_EXPLAIN'				=> '任何輸入的 HTML 標籤都會以原貌顯示。如果所選的版面類型是一個分區，則不使用該描述。',
	...
	'FORUM_NAME_EMOJI'					=> '您輸入的版面名稱無效。<br>它包含以下不受支援的字符：<br>%s',
	...
	'LINK'					=> '連結',
	'LIMIT_SUBFORUMS'			=> '限制為直接子版面',
	'LIMIT_SUBFORUMS_EXPLAIN'	=> '將子版面限制再顯示子版面為目前版面的直接後代（孩子）。禁用此功能與「顯示子版面列表」的選項啟用，將顯示所有的子版面，不論深度。',
