...
$lang = array_merge($lang, array(
	...
	'ACP_BAN_EXPLAIN'	=> '在這裡，您可以使用會員名稱、IP 或電子郵件位址來進行封鎖控制。這些方法防止會員到達討論區的任何部分。如果您希望的話，那麼您可以給予一段簡短的 (最多 3000 個字元) 封鎖理由。這將會被顯示在管理記錄中。封鎖的時間期限也可以被指定。假如您要這個封鎖在特定日期結束的話，可以在封鎖期限的下拉選單選擇 <span style="text-decoration: underline;">直到 -&gt;</span> 並且依格式 <kbd>YYYY-MM-DD</kbd> 輸入日期就可以了。',
	...
	'EMAIL_BAN'					=> '封鎖一個或更多個電子郵件位址',
	'EMAIL_BAN_EXCLUDE_EXPLAIN'	=> '啟用這個功能由所有目前的封鎖中排除已輸入的電子郵件位址。',
	'EMAIL_BAN_EXPLAIN'			=> '要指定多個電子郵件位址，請每一行輸入一個。可以使用 * 當作萬用字元，表示符合的部分位址，例如：<samp>*@hotmail.com</samp>、<samp>*@*.domain.tld</samp>、...等。',
	'EMAIL_NO_BANNED'			=> '沒有封鎖的電子郵件位址',
	'EMAIL_UNBAN'				=> '解除封鎖或解除排除的電子郵件位址',
	'EMAIL_UNBAN_EXPLAIN'		=> '您可以使用適當的滑鼠與鍵盤的結合，一次選擇多個電子郵件位址，執行解除封鎖或解除排除的操作。排除的電子郵件位址有特別背景標示。',
