...
$lang = array_merge($lang, array(
	'ACP_MASS_EMAIL_EXPLAIN'		=> '在這裡，您可以給所有的會員或者某個特別的<strong>能夠接收大量郵件</strong>的群組會員發送電子郵件。發送時，將會透過管理員的連絡郵件帳號進行發送，同時也發送副本到其他收信人的郵箱中。預設每份電子郵件只能有 50 位收信人，要發送給更多收信人就需要發送更多的電子郵件。如果您要給一大群人發送電子郵件，當送出後請耐心等待不要中途停止這個頁面。一般而言，大量發送電子郵件需要很長一段時間，當程序完成時會通知您。',
	'ALL_USERS'						=> '所有會員',
