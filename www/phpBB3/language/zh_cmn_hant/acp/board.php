...
$lang = array_merge($lang, array(
	...
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> '時間格式相同於 PHP <code><a href="https://secure.php.net/manual/function.date.php">date()</a></code> 函式。',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_CDN_EXPLAIN'				=> '如果啟用此設定，某些檔將會從外部伺服器連線而不是從您的伺服器。這減少了您的伺服器所需的網路頻寬，但可能會造成一些討論區管理員私隱的問題。在 phpBB 的預設安裝，這包括載入「jQuery」以及透過 Google 載入「Open Sans」的字體。',
