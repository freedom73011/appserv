...
$lang = array_merge($lang, array(
	...
	'ATTACH_COMMENT_NO_EMOJIS'	=> '附加檔案的註釋包含被禁用的字符（表情符號）。',
	...
	'STICKY_ANNOUNCE_TIME_LIMIT'=> '置頂/公告/全域公告的期限設定',
	'STICK_TOPIC_FOR'			=> '主題置頂期限',
	'STICK_TOPIC_FOR_EXPLAIN'	=> '輸入 0 表示沒有期限的置頂/公告/全域公告。請注意！這個數字是相對於該文章的發文日期。',
